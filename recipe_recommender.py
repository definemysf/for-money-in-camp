...
def main():
    ...
    try:
        ...
        # 2. 输出现有食材
        ingredients = ["鸡蛋", "米", "面","油", "糖", "盐", "酱油", "花椒", "姜", "蒜"]
        more = input("🍆🌶🥔请输入冰箱里除调味料外的其它食材（用空格分隔，如 西红柿 青椒 豆腐 茄子 干辣椒 葡萄干 鸡肉 猪肉 牛肉 土豆 黄瓜 羊肉 胡萝卜 洋葱 ）：\n").split()
        more = input("🍆🌶🥔当然我不会告诉你Ctrl+Shift+C可以复制我上面的Ctrl+Shift+V可以粘贴\n").split()
        if more:
